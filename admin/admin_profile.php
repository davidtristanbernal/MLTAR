...
<div class="wrapper">
  <div class="sidebar">
    <ul>
      ...
      <li><a href="admin_profile.php" class="active"><i class="fa fa-user-circle"></i> Profile</a></li>
      ...
      <tbody>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
          ...
          foreach ($updatedData as $doctorId => $doctorData) {
            ...
            $updateSql = "UPDATE doctors SET first_name = '$updatedFirstName', middle_name = '$updatedMiddleName', last_name = '$updatedLastName', cellphone = '$updatedCellphone', address = '$updatedAddress', age = '$updatedAge', gender = '$updatedGender', email = '$updatedEmail' WHERE id = $doctorId";
