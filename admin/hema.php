...
<title>Patient | Hematology</title>
...
<div class="wrapper">
  ...
  <div class="content">
    ...
    if (isset($_GET['search'])) {
      ...
      $stmt = $conn->prepare("SELECT * FROM hematology_results WHERE name LIKE ?");
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
                    ...
                    <table id="table">
                      ...
                      <tfoot>
                        ...
                        <tr>
                          ...
                          <td>M 0.42-0.52<br>F O.37-0.47</td>
                        </tr>
                        <tr>
                          <td>RBC</td>
                          <td>' . $row['rbc'] . '</td>
                          <td>M 5.5-6.5X10/L<br>F 4.5-5.5X10/L</td>
                          <td>Segmenter</td>
                          <td>' . $row['segmenter'] . '</td>
                          <td>0.40-60%</td>
                        </tr>
          ...
          echo '<br>';
          // Share form
          echo '<form method="post" action="../user/hema.php">
          <input type="hidden" name="hematology_id" value="' . $row['id'] . '">
          <h3>Share Hematology Results</h3>
          <div class="form-group">
            <label for="email">Email : </label>
            <input type="email" name="email" id="email" class="no-decoration email-input" required>
          </div>
          <div class="form-group">
