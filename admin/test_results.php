...
<title>Patients | Test Results</title>  
...
<div class="wrapper">
  ...
  <button class="toggle-sidebar-btn"> <i class="fas fa-bars fa-2x"></i></button>
    <h2>Patients | Test Results </h2>

    <div class="dashboard-section">
    <div class="box-container">
  <div class="box" style="background-color: #CD853F;">
    <a href="hema.php"><i class="fas fa-vial fa-3x"></i></a>
    <p>Hematology</p>
  </div>
  <div class="box" style="background-color: #708090;">
    <a href="urine.php"><i class="fas fa-flask fa-3x"></i></a>
    <p>Urinalysis</p>
  </div>
  <div class="box" style="background-color: #008080;">
    <a href="blood.php"><i class="fas fa-tint fa-3x" style="color:darkred;"></i></a>
