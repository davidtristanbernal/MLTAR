    ...
    <h2>Welcome to your Payments </h2>
            <div class="dashboard-section">
                <div class="box-container">
                    ...
                    <a href="javascript:void(0);" onclick="showPopupForm()"><i class="fas fa-qrcode fa-3x"></i></a>
                        <p>Payment</p>
                ...
                <div id="popupForm">
                    <form action="payment.php" method="post">
                        ...
                        <div id="gcashFields" class="hidden">
                            ...
                            <input type="text" id="gcash_account_name" name="gcash_account_name"><br><br>

                            <label for="gcash_account_number">GCash Account Number :</label>
                            <input type="text" id="gcash_account_number" name="gcash_account_number"><br><br>
                        </div>
